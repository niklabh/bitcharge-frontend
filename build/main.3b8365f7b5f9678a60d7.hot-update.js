...
server.disable('x-powered-by').use(express__WEBPACK_IMPORTED_MODULE_5___default.a.static("/Users/Yogesh/Projects/Bitcharge/bit-web/public")).get('/*', function (req, res) {
  ...
  var renderMarkup = function renderMarkup() {
    ...
    var initialDataError = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    ...
    var markup = Object(react_dom_server__WEBPACK_IMPORTED_MODULE_6__["renderToString"])(react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(
      ...
      react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_App__WEBPACK_IMPORTED_MODULE_2__["default"], { routes: _routes__WEBPACK_IMPORTED_MODULE_8__["default"], initialData: data, initialDataError: initialDataError, __source: {
          fileName: _jsxFileName,
          lineNumber: 42
        }
      })
  ...
  babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a.all(promises).then(function (data) {
    res.status(200).send(renderMarkup(data));
  }).catch(function (error) {
    console.log(error);
    res.status(200).send(renderMarkup(null, error));
  });
});
...
//# sourceMappingURL=main.3b8365f7b5f9678a60d7.hot-update.js.map